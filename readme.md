...
A social game engine built in C++ with Lua scripting (object ir scripting comeing soon), designed for creating multiplayer games with a focus on social interaction and fun. The engine provides a modular architecture, allowing developers to easily create and manage game content through asset packs and Lua scripts.
