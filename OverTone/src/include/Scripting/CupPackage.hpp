...
public:
    ...
    /// If the package contains a native module (platform-specific extension)
    /// return its full path, otherwise return an empty string.
    std::string nativeModulePath() const;
